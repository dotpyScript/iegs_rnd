  ...
  const notifications = [
    {
      ...
      message: 'You have been assigned to Project X1',
      time: '5m ago',
      read: false,
    },
    {
    ...
    >
      ...
      <div className='flex items-center gap-3'>
        ...
        >
          {/* Sun Icon (Left) */}
          <div
            className={`flex items-center justify-center w-6 h-6 rounded-full transition-all duration-300 z-10 text-white`}
          >
          ...
          {/* Moon Icon (Right) */}
          <div
            className={`flex items-center justify-center w-6 h-6 rounded-full transition-all duration-300 z-10 text-white ml-2`}
          >
          ...
          >
            ...
            {unreadCount > 0 && (
              <motion.span
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
                className='absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] flex items-center justify-center bg-black text-white text-[10px] font-bold rounded-full px-1 shadow-lg'
              >
                {unreadCount}
              </motion.span>
            )}
              ...
              >
                <div className='p-3 border-b border-gray-200 dark:border-gray-300 bg-gray-100 dark:bg-gray-100'>
                  <div className='flex items-center justify-between'>
                    ...
                    {unreadCount > 0 && (
                      <span className='px-2 py-0.5 text-[10px] font-semibold bg-black text-white rounded-full shadow-md'>
                        {unreadCount} new
                      </span>
                    )}
                  </div>
                  ...
                  {notifications.map((notification) => (
                    ...
                    >
                      <div className='flex items-start gap-2'>
                        <div
                          className={`w-1.5 h-1.5 rounded-full mt-1.5 flex-shrink-0 bg-gray-300 dark:bg-gray-300`}
                        />
                ...
                <div className='p-2 border-t border-gray-200 dark:border-gray-300 bg-gray-50 dark:bg-gray-50'>
                  <button className='w-full text-xs font-semibold text-black hover:text-gray-700 dark:hover:text-teal-600 transition-colors py-1'>
        ...
        <div className='relative' style={{ width: '200px' }}>
          <div className='flex items-center gap-2 rounded-lg px-3 py-2 border-2 border-gray-300 dark:border-gray-300 bg-white dark:bg-white hover:border-black focus-within:border-black dark:focus-within:border-black focus-within:shadow-md transition-all duration-200'>
            ...
            <input
              ...
              className='bg-transparent border-none flex-1 text-sm text-black  placeholder-gray-500 min-w-0 focus:outline-none focus:ring-0 focus:shadow-none'
            />
            <motion.button
            ...
            >
              <Mic className='w-4 h-4 text-black dark:text-black' />
            </motion.button>
          </div>
        </div>
      </div>
