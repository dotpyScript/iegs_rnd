                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {equipment.map((item) => (
                                    ...
                                    >
                                        ...
                                        <div className="space-y-2 mb-3 pb-3 border-b-2 border-gray-100">
                                            <div className="flex items-center justify-between">
                                                <span className="text-xs text-gray-600">Status</span>
                                                <span className={`text-xs font-semibold px-2 py-0.5 rounded ${item.status === 'operational' ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'
                                                    }`}>
                                        ...
                                        <div className="text-xs text-gray-600 space-y-1 mb-3">
                                            <div className="flex items-center gap-2">
                                                <Clock size={14} />
                                                <span>Last: {item.lastCalibration}</span>
                                            </div>
                                            <div className="flex items-center gap-2">
                                                <AlertTriangle size={14} />
                                                <span>Next: {item.nextCalibration}</span>
                                            </div>
                                        </div>
