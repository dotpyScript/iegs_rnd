...
const ProjectsOverview = () => {
  ...
  const projects = [
    {
      ...
      priority: 'high',
      budget: '₦25M',
      description: 'Develop comprehensive GIS mapping solution',
      milestones: [
        {
        ...
        { name: 'Testing & QA', status: 'upcoming', date: '2024-06-15' },
      ],
    },
    {
      id: 2,
      ...
      priority: 'medium',
      budget: '₦18M',
      description: 'UAV operations management system',
      milestones: [
        {
        ...
        { name: 'Development Phase 1', status: 'upcoming', date: '2024-06-01' },
        { name: 'Integration Testing', status: 'upcoming', date: '2024-07-20' },
      ],
    },
    {
      id: 3,
      name: 'Survey Data Analytics',
      status: 'pending',
      progress: 15,
      ...
      priority: 'low',
      budget: '₦12M',
      description: 'Advanced analytics for survey data processing',
      milestones: [
        { name: 'Kickoff Meeting', status: 'completed', date: '2024-03-15' },
        { name: 'Data Collection', status: 'in-progress', date: '2024-04-30' },
        { name: 'Analysis Framework', status: 'upcoming', date: '2024-06-20' },
        { name: 'Reporting Tools', status: 'upcoming', date: '2024-08-15' },
      ],
    },
  ];
  ...
  const views = [
    ...
    },
    {
      ...
      label: 'Messages',
      icon: MessageSquare,
      tooltip: 'Project Messages',
    },
    { id: 'files', label: 'Files', icon: Paperclip, tooltip: 'Project Files' },
  ];
  ...
  const getPriorityColor = (priority) => {
    switch (priority) {
      case 'high':
        return 'text-gray-900 bg-gray-900';
      case 'medium':
      ...
      <div className="space-y-3">
        {projects.map((project, idx) => (
          ...
          >
            ...
            {expandedProjects[project.id] && (
              <div className="px-5 pb-5 pt-2 border-t-2 border-gray-100 animate-slideDown">
                ...
                <div className="flex gap-2 mt-4 ml-8">
                  <button className="flex items-center gap-2 px-3 py-1.5 text-xs font-medium border-2 border-gray-200 rounded-lg hover:bg-black hover:text-white hover:border-black transition-all">
                    <UserPlus size={14} />
                    Assign Team
                  </button>
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-1.5 text-xs font-medium border-2 border-gray-200 rounded-lg hover:bg-black hover:text-white hover:border-black transition-all"
                  >
                    <Plus size={14} />
                    Add Task
                  </button>
        ...
        <div className="border-2 border-gray-200 rounded-lg p-4 bg-white">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex gap-2">
              <button className="px-3 py-1.5 text-xs font-medium border-2 border-gray-200 rounded-lg hover:bg-black hover:text-white transition-all">
                Today
              </button>
              <button className="px-3 py-1.5 text-xs font-medium bg-black text-white rounded-lg">
                2024
              </button>
            </div>
          </div>
          ...
          <div className="space-y-3">
            {timelineData.map((project, idx) => {
              ...
              const leftOffset = (startMonth / 12) * 100;
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 relative h-10">
                    <div
                      className="absolute top-1/2 -translate-y-1/2 h-8 bg-black rounded-lg flex items-center px-3 cursor-pointer hover:bg-gray-800 transition-colors group"
                    ...
                    >
                      <div className="flex-1 flex items-center justify-between">
                        <div className="flex -space-x-1">
                          {project.team.slice(0, 3).map((member, i) => (
                            <div
                              key={i}
                              className="w-5 h-5 bg-white text-black rounded-full flex items-center justify-center text-[10px] font-semibold border border-black"
                            >
                              {member}
                            </div>
                          ))}
                      ...
                      <div className="absolute bottom-full left-0 mb-2 hidden group-hover:block">
                        <div className="bg-white border-2 border-gray-200 rounded-lg p-3 shadow-lg whitespace-nowrap">
      ...
      <div className="space-y-4 animate-fadeIn">
        <div className="border-2 border-gray-200 rounded-lg p-5 bg-white">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex gap-2">
              <button className="p-2 border-2 border-gray-200 rounded-lg hover:bg-black hover:text-white transition-all">
          ...
          {/* Calendar Grid */}
          <div className="grid grid-cols-7 gap-px bg-gray-200 border-2 border-gray-200 rounded-lg overflow-hidden">
            {/* Day Headers */}
            {days.map((day) => (
              <div
                key={day}
                className="bg-gray-50 p-3 text-center text-xs font-semibold text-gray-900"
              >
                {day}
              </div>
            ))}
                ...
                >
                  ...
                  {hasEvent && (
                    <div className="space-y-1">
                      <div className="bg-black text-white px-2 py-1 rounded text-[10px] font-medium truncate cursor-pointer hover:bg-gray-800 transition-colors">
                        Project Review
                      </div>
                    </div>
                  )}
        ...
        <div className="border-2 border-gray-200 rounded-lg p-5 bg-white">
          ...
          <div className="space-y-3">
            {[
              ...
              <div
                key={i}
                className="flex items-center justify-between p-3 border-2 border-gray-200 rounded-lg hover:border-black transition-all"
              >
                <div className="flex items-center gap-3">
                  <div
  ...
  const renderMessages = () => (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 animate-fadeIn">
      {/* Conversations List */}
      <div className="lg:col-span-1 border-2 border-gray-200 rounded-lg bg-white">
          ...
          {projects.map((project) => (
            ...
            >
              ...
              <p className="text-xs text-gray-600 truncate">
                Latest update on milestone progress...
              </p>
              <div className="flex -space-x-1 mt-2">
                {project.team.slice(0, 3).map((member, i) => (
                  <div
                    key={i}
                    className="w-6 h-6 bg-black text-white rounded-full flex items-center justify-center text-[10px] font-semibold border-2 border-white"
                  >
                    {member}
                  </div>
                ))}
      ...
      {/* Messages Panel */}
      <div className="lg:col-span-2 border-2 border-gray-200 rounded-lg bg-white flex flex-col h-[600px]">
        <div className="p-4 border-b-2 border-gray-200">
          ...
          {selectedProject ? (
            <>
              <div className="flex gap-3">
                <div className="w-8 h-8 bg-black text-white rounded-full flex items-center justify-center text-xs font-semibold flex-shrink-0">
                  JD
                </div>
                <div>
                  ...
                  <div className="bg-gray-100 rounded-lg p-3 text-sm text-gray-900">
                    Just completed the backend API integration. Ready for
                    testing.
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <div className="bg-gray-100 rounded-lg p-3 text-sm text-gray-900">
                    Great! I'll start the UI testing this afternoon.
                  </div>
                </div>
              </div>
            </>
          ...
          <div className="p-4 border-t-2 border-gray-200">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 text-sm border-2 border-gray-200 rounded-lg focus:outline-none focus:border-black transition-colors"
              />
    ...
    <div className="space-y-4 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {[
          ...
          <div
            key={idx}
            className="border-2 border-gray-200 rounded-lg p-4 hover:border-black transition-all duration-300 cursor-pointer bg-white animate-slideUp"
            style={{ animationDelay: `${idx * 50}ms` }}
          >
            <div className="flex items-start justify-between mb-3">
            ...
            <form className="p-6 space-y-6">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {['JD', 'SS', 'MJ', 'EW', 'DB', 'LC'].map((member) => (
                    <button
                      key={member}
                      type="button"
                      className="w-10 h-10 bg-gray-200 hover:bg-black hover:text-white text-gray-700 rounded-full flex items-center justify-center text-xs font-semibold transition-all"
                    >
                      {member}
                    </button>
                  ))}
                ...
                <div className="flex gap-2">
                  {selectedProject?.team.map((member) => (
                    <button
                      key={member}
                      type="button"
                      className="w-9 h-9 bg-gray-200 hover:bg-black hover:text-white text-gray-700 rounded-full flex items-center justify-center text-xs font-semibold transition-all"
                    >
                      {member}
                    </button>
                  ))}
