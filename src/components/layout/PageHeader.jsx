...
const PageHeader = ({ 
  ...
  return (
    ...
    >
      ...
      <div>
        <h3 className="text-lg lg:text-3xl font-display font-bold text-gray-800 tracking-tight">
          {title}
        </h3>
        ...
        {showExport && (
          <div className="relative" ref={exportDropdownRef}>
            <motion.button
              ...
              className="flex items-center gap-2 px-1 py-1 bg-white border-2 border-gray-200 rounded font-semibold text-gray-700 hover:border-primary-200 hover:bg-primary-50 transition-all duration-200 shadow-sm"
            >
